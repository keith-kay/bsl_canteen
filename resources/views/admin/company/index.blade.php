                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{url('companies/'.$company->bsl_cmn_user_types_id.'/edit') }}" class="btn btn-success">Edit</a>
                                <a href="{{url('companies/'.$company->bsl_cmn_user_types_id.'/delete') }}" class="btn btn-danger">Delete</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
